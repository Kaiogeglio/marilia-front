...
export const TextStyleVariantsMap = {
  ...
  `,
  headlineException: css`
    font-size: ${({ theme }) => theme.typographyVariants.headlineException.fontSize};
    font-weight: ${({ theme }) => theme.typographyVariants.headlineException.fontWeight};
    line-height: ${({ theme }) => theme.typographyVariants.headlineException.lineHeight};
  `,
  title: css`
    ${({ theme }) => css`
